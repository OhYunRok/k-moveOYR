                    ...
                    <div class="product-single-content">
                        ...
                        <form action="checkout">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <label>내용 *</label>
                                    <textarea name="massage" id="content" placeholder="상품 상세 내용을 입력하세요"></textarea>
                                </div>
								...
								<div class="row">
									...
									<div class="col-xl-12 form-group">
										<textarea id="priceUpdate" class="form-control"
											 placeholder="가격"></textarea>
									</div>
									<div class="col-xl-12 form-group">
										<textarea id="quantityUpdate" class="form-control"
											 placeholder="수량"></textarea>
									</div>
									<div class="col-xl-12 form-group">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body d-flex">
                    <div class="product-single-content">
                        <h4 class="modal-title" id="boardDetailModalTitle" id="">상품 상세</h4>
                    <table class="table table-hover">
                      <tbody>
                        <tr><td width="100px">글번호</td><td id="productId">#</td></tr>
...
<!--                         <button id="btnBoardUpdateForm" class="btn btn-sm btn-primary btn-outline" type="button" style="z-index: 2050;">글 수정하기</button>
					 ...
					 -->
	                     <li><a id="btnBoardUpdateForm" href="#">글 수정하기</a></li>
    	                 <li><a id="btnBoardDeleteConfirm" href="#">글 삭제하기</a></li>
