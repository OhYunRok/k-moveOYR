...
<body>
    ...
    <div class="breadcumb-area bg-img-3 ptb-100">
        <div class="container">
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="about-wrap text-center">
                        <h3>Welcome Our Store! </h3>
                       	<p>OEshop은 일반적인 상품만 팔지 않습니다. 저희는 스토리,이야기를 판매합니다. 지역내 소외계층과 지방에 힘드신 어르신들이 공급자로 참여하여 단순 물질적 가치뿐아니라 사회적가치를 상기시킵니다.</p>
                        <p>저희는 사회적가치와 물질적가치 모두 얻을수 있는 OEshop입니다. 소비자는 상품을 구매하는 것 뿐만아니라 각 소외계층들의 스토어 설명과 현황을 보고 추가적인 사회적 가치를 구매할 수 있게해줍니다.</p>
                        <p class="mb-0">OEshop does not sell only general merchandise. We sell stories and stories. Senior citizens who are struggling in the marginalized and local communities in the region participate as suppliers to remind them of social values as well as simple material values.</p>
                        <p>We are OEshop that can get both social value and material value. In addition to purchasing products, consumers can also view store descriptions and status of each underprivileged and purchase additional social value.</p>
                    </div>
                </div>
            </div>
        </div>
